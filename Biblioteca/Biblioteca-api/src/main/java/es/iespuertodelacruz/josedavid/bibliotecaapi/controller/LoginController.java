package es.iespuertodelacruz.josedavid.bibliotecaapi.controller;
...
import es.iespuertodelacruz.josedavid.bibliotecaapi.security.GestorJWT;
...
public class LoginController {
	...
	private String getJWTToken(String username, String passTextoPlanoRecibida) {
		...
		GestorJWT gestorDeJWT = GestorJWT.getInstance();
		
		Operador operador = operadorService.findByNick(username);
        ...
        if(operador != null) { 
        	passwordUsuarioEnHash = operador.getPassword();
